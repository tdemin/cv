...
\cventry{\textbf{Dec 2021 --- Jun 2023}}{DevOps / Platform Engineer}{RN-BashNIPIneft LLC}{}{}{
    ...
    \item
        Worked on an internal development platform (IDP) based on Gitea / Jenkins / Nexus /
        Harbor. Maintained IDP-specific innerworkings. Developed IDP-specific release engineering
        and automation software.
    \item
        Managed both IDP-internal and project-specific monitoring and logging services.
        Maintained team-specific monitoring for Oracle XE and PostgreSQL.
    \item
        Administered corporate YouTrack instance, developed JavaScript workflows for teams using
        YouTrack for tech support.
    \item
